...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "boş daire temizliği İstanbul",
    "derin temizlik İstanbul",
    "halı yıkama İstanbul",
    "koltuk yıkama İstanbul",
    "dezenfeksiyon hizmeti İstanbul",
    "Arnavutköy temizlik şirketi",
    "Arnavutköy ev temizliği",
    "Başakşehir temizlik şirketi",
    "Başakşehir ev temizliği",
    "zirve temizlik",
    "7/24 temizlik hizmeti",
    "sigortalı temizlik ekibi",
    "aynı gün temizlik İstanbul",
  ],
