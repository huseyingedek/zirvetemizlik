      ...
      <div className="container mx-auto px-4 py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            <span className="bg-blue-600 text-white rounded-lg px-2 py-1 text-sm font-black">
              ZT
            </span>
          ...
          <div className="flex gap-3">
            {/* Instagram */}
            <a
              href="https://instagram.com/zirvetemizlik"
              target="_blank"
            ...
            {/* Facebook */}
            <a
              href="https://facebook.com/zirvetemizlik"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors"
            ...
            {/* Twitter/X */}
            <a
              href="https://twitter.com/zirvetemizlik"
              target="_blank"
              rel="noopener noreferrer"
